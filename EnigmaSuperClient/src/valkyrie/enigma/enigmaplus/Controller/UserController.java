...
//        r.addProperty(p4, "String.valueOf(uid)", XSDDatatype.XSDstring);
    ...
    public void newUser( String fname, String lname, String email,String password, String interested, String designation,String path){
        String uidString = "0";
        long uid;
        Model model = FileManager.get().loadModel(rdfPath.rdfPath);
        String queryString = "PREFIX sep: <http://www.semanticweb.org/hesh/ontologies/valkyrie/enigmaplus/ontology#>"
        ...
        Property p5 = m.createProperty(NS + "designation");
        Property p6 = m.createProperty(NS + "picture");
        Property p7 = m.createProperty(NS + "uid");
        Property p8 = m.createProperty(NS + "password");
        Property p9 = m.createProperty(NS + "reputation");
        Property p10 = m.createProperty(NS + "availability");
        ...
        r.addProperty(p5, designation , XSDDatatype.XSDstring);
        r.addProperty(p6, path , XSDDatatype.XSDstring);
        r.addProperty(p7, String.valueOf(uid) , XSDDatatype.XSDstring);
        r.addProperty(p8, password , XSDDatatype.XSDstring);
        r.addProperty(p9, "0" , XSDDatatype.XSDstring);
        r.addProperty(p10, "available" , XSDDatatype.XSDstring);
